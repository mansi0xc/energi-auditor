...
import type { BusinessMetrics, UsageInsight } from '@/lib/analytics';
...
export default function LogsPage() {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      // Fetch statistics and recent logs in parallel
        ...
        <div className="flex items-center justify-center min-h-[60vh]">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Admin access required to view logs dashboard.
            </p>
            <Button asChild>
              <a href="/audit">Go to Audit</a>
            </Button>
          </div>
        </div>
      </div>
